...
namespace Rems_Auth.Migrations
{
    ...
    [Migration("20241229155657_added message model")]
            ...
            modelBuilder.Entity("Rems_Auth.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("d98f3887-1263-4fe7-8473-3ea5ca2037aa"),
                            CreatedAt = new DateTime(2024, 12, 29, 15, 56, 56, 422, DateTimeKind.Utc).AddTicks(794),
