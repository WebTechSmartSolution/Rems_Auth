...
namespace Rems_Auth.Migrations
{
    ...
    [Migration("20250124130551_update listing or user endpont")]
    partial class updatelistingoruserendpont
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rems_Auth.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("31f661e9-914d-4088-aeac-33d83a201872"),
                            CreatedAt = new DateTime(2025, 1, 24, 13, 5, 50, 455, DateTimeKind.Utc).AddTicks(6171),
            ...
            modelBuilder.Entity("Rems_Auth.Models.Chat", b =>
                {
                    b.HasOne("Rems_Auth.Models.AddListing", null)
                        .WithMany("Chats")
                        .HasForeignKey("ListingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
